...
\033[97;1m>>     Toolsname: BRAND-PRO
\033[92;1m>>     Tol Typ  : \x1b[91;1m TRIAL
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
...
def login():
        ...
        try:
                print('\n Validating cookies ... ')
                data = requests.get("https://free..facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5"}, cookies = {"cookie":cookies})
